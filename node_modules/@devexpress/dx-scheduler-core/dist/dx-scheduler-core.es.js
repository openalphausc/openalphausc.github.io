...
var getAppointmentResources = function (appointment, resources, plainResources) {
    ...
    return resources.reduce(function (acc, resource) {
        ...
        if (resource.allowMultiple) {
            return __spread(acc, appointmentResourceId.map(function (itemId) { return plainResources.find(function (plainItem) { return resource.fieldName === plainItem.fieldName && plainItem.id === itemId; }); }));
        }
